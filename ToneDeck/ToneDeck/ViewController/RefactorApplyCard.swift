//
//  RefactorApplyCard.swift
//  ToneDeck
//
//  Created by 謝霆 on 2024/10/21.
//
...
struct RefactorApplyCardViewControllerWrapper: UIViewControllerRepresentable {
    let card: Card?
...
struct RefactorApplyCardView: View {
...
class RefactorApplyCardViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, CameraViewControllerDelegate {
    var card: Card?
